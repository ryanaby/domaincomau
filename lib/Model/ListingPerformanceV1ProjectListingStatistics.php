...
/**
 * ListingPerformanceV1ProjectListingStatistics Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListingPerformanceV1ProjectListingStatistics implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListingPerformance.v1.ProjectListingStatistics';
    ...
    protected static $swaggerTypes = [
        ...
        'total_statement_of_information_downloads' => 'int',
        'total_statement_of_information_reveals' => 'int',
        'total_added_notes' => 'int',
        'total_completed_inspection_checklist' => 'int',
        'total_virtual_tour_views' => 'int',
        'listing_id' => 'int'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'total_statement_of_information_downloads' => 'int32',
        'total_statement_of_information_reveals' => 'int32',
        'total_added_notes' => 'int32',
        'total_completed_inspection_checklist' => 'int32',
        'total_virtual_tour_views' => 'int32',
        'listing_id' => 'int32'
    ];
    ...
    protected static $attributeMap = [
        ...
        'total_statement_of_information_downloads' => 'totalStatementOfInformationDownloads',
        'total_statement_of_information_reveals' => 'totalStatementOfInformationReveals',
        'total_added_notes' => 'totalAddedNotes',
        'total_completed_inspection_checklist' => 'totalCompletedInspectionChecklist',
        'total_virtual_tour_views' => 'totalVirtualTourViews',
    ...
    protected static $setters = [
        ...
        'total_statement_of_information_downloads' => 'setTotalStatementOfInformationDownloads',
        'total_statement_of_information_reveals' => 'setTotalStatementOfInformationReveals',
        'total_added_notes' => 'setTotalAddedNotes',
        'total_completed_inspection_checklist' => 'setTotalCompletedInspectionChecklist',
        'total_virtual_tour_views' => 'setTotalVirtualTourViews',
    ...
    protected static $getters = [
        ...
        'total_statement_of_information_downloads' => 'getTotalStatementOfInformationDownloads',
        'total_statement_of_information_reveals' => 'getTotalStatementOfInformationReveals',
        'total_added_notes' => 'getTotalAddedNotes',
        'total_completed_inspection_checklist' => 'getTotalCompletedInspectionChecklist',
        'total_virtual_tour_views' => 'getTotalVirtualTourViews',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['total_statement_of_information_downloads'] = isset($data['total_statement_of_information_downloads']) ? $data['total_statement_of_information_downloads'] : null;
        $this->container['total_statement_of_information_reveals'] = isset($data['total_statement_of_information_reveals']) ? $data['total_statement_of_information_reveals'] : null;
        $this->container['total_added_notes'] = isset($data['total_added_notes']) ? $data['total_added_notes'] : null;
        $this->container['total_completed_inspection_checklist'] = isset($data['total_completed_inspection_checklist']) ? $data['total_completed_inspection_checklist'] : null;
        $this->container['total_virtual_tour_views'] = isset($data['total_virtual_tour_views']) ? $data['total_virtual_tour_views'] : null;
     ...
     *
     * @param int $total_shortlisted Total number of times the listing was short listed
     *
     * @return $this
     */
    ...
    /**
     * Gets total_statement_of_information_downloads
     *
     * @return int
     */
    public function getTotalStatementOfInformationDownloads()
    {
        return $this->container['total_statement_of_information_downloads'];
    }

    /**
     * Sets total_statement_of_information_downloads
     *
     * @param int $total_statement_of_information_downloads Total number of times when statement of information download
     *
     * @return $this
     */
    public function setTotalStatementOfInformationDownloads($total_statement_of_information_downloads)
    {
        $this->container['total_statement_of_information_downloads'] = $total_statement_of_information_downloads;

        return $this;
    }

    /**
     * Gets total_statement_of_information_reveals
     *
     * @return int
     */
    public function getTotalStatementOfInformationReveals()
    {
        return $this->container['total_statement_of_information_reveals'];
    }

    /**
     * Sets total_statement_of_information_reveals
     *
     * @param int $total_statement_of_information_reveals Total number of times when statement of information reveals
     *
     * @return $this
     */
    public function setTotalStatementOfInformationReveals($total_statement_of_information_reveals)
    {
        $this->container['total_statement_of_information_reveals'] = $total_statement_of_information_reveals;

        return $this;
    }

    /**
     * Gets total_added_notes
     *
     * @return int
     */
    public function getTotalAddedNotes()
    {
        return $this->container['total_added_notes'];
    }

    /**
     * Sets total_added_notes
     *
     * @param int $total_added_notes Total number of times when notes added
     *
     * @return $this
     */
    public function setTotalAddedNotes($total_added_notes)
    {
        $this->container['total_added_notes'] = $total_added_notes;

        return $this;
    }

    /**
     * Gets total_completed_inspection_checklist
     *
     * @return int
     */
    public function getTotalCompletedInspectionChecklist()
    {
        return $this->container['total_completed_inspection_checklist'];
    }

    /**
     * Sets total_completed_inspection_checklist
     *
     * @param int $total_completed_inspection_checklist Total number of completed inspection checklist
     *
     * @return $this
     */
    public function setTotalCompletedInspectionChecklist($total_completed_inspection_checklist)
    {
        $this->container['total_completed_inspection_checklist'] = $total_completed_inspection_checklist;

        return $this;
    }

    /**
     * Gets total_virtual_tour_views
     *
     * @return int
     */
    public function getTotalVirtualTourViews()
    {
        return $this->container['total_virtual_tour_views'];
    }

    /**
     * Sets total_virtual_tour_views
     *
     * @param int $total_virtual_tour_views Total number of views from virtual tours
     *
     * @return $this
     */
    public function setTotalVirtualTourViews($total_virtual_tour_views)
    {
        $this->container['total_virtual_tour_views'] = $total_virtual_tour_views;
