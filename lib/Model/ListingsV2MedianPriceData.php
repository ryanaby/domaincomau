...
/**
 * ListingsV2MedianPriceData Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListingsV2MedianPriceData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Listings.V2.MedianPriceData';
     ...
     * Sets source
     *
     * @param string $source Where median price data comes from
     *
     * @return $this
     */
     ...
     *
     * @param string $source_date_from Start date of the median price source time period
     *
     * @return $this
     */
     ...
     * Sets source_date_to
     *
     * @param string $source_date_to End date of the median price source time period
     *
     * @return $this
     */
     ...
     *
     * @param string $source_collection_date The collection date of the median price source
     *
     * @return $this
     */
