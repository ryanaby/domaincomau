...
/**
 * ListingPerformanceV1DailyStatistics Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListingPerformanceV1DailyStatistics implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ListingPerformance.v1.DailyStatistics';
     ...
     * Sets event_date
     *
     * @param \DateTime $event_date Date of statistics events
     *
     * @return $this
     */
