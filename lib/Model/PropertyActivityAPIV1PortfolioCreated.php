...
/**
 * PropertyActivityAPIV1PortfolioCreated Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PropertyActivityAPIV1PortfolioCreated implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PropertyActivityAPI.v1.PortfolioCreated';
     ...
     * Sets portfolio_id
     *
     * @param string $portfolio_id Unique ID for the portfolio
     *
     * @return $this
     */
